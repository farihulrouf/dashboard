...
export const getCourses = async (filter) => {
  const { data } = await axios.post("/api/courses", filter);
  return data;
};
...
export const getExams = async (courseId, page, limit) => {
  const { data } = await axios.get(
  `/api/courses/${courseId}/exams?limit=${limit}&page=${page}`
  );
  return data
}

export const getExercises = async (courseId, page, limit) => {
  const { data } = await axios.get(
  `/api/courses/${courseId}/exercises?limit=${limit}&page=${page}`
  );
  return data
}

export const getQuestionPools = async (courseId, page, limit) => {
  const { data } = await axios.get(
  `/api/courses/${courseId}/questionpools?limit=${limit}&page=${page}`
  );
  return data
}